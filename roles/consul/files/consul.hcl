...
#encrypt = "..."
encrypt = "uRYUoc+ixknuYJ0VRveHvywVZwWCq8tgZSHqSViSBSc="
ca_file="/etc/consul.d/consul-agent-ca.pem"
cert_file="/etc/consul.d/vagrant-server-consul-0.pem"
key_file = "/etc/consul.d/vagrant-server-consul-0-key.pem"
